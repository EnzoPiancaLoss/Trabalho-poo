...
def criar_banco_padrao():
    ...
    bd.Criar_table(
        "Livro",
        "id_livro INTEGER PRIMARY KEY, nome TEXT, lancamento DATE, paginas INTEGER, unidades_totais INTEGER"
    )
    ...
    bd.Criar_table(
        "Emprestimo",
        "id_emprestimo INTEGER PRIMARY KEY, id_livro INTEGER, id_cliente INTEGER, status TEXT, data_retornado DATE, " +
...
def preencher_banco_padrao():
    ...
    bd.Adicionar_dado_a_table_ESPECIFICO(
        ...
        ["Livro A", "2020-01-01", 200, 1]
    )
    bd.Adicionar_dado_a_table_ESPECIFICO(
        "Livro",
        ["nome", "lancamento", "paginas", "unidades_totais"],
        ["Livro B", "2021-06-15", 350, 10]
    )
    ...
    bd.Adicionar_dado_a_table_ESPECIFICO(
        "Emprestimo",
        ["id_livro", "id_cliente", "data_emprestimo", "data_devolucao", "status", "data_retornado"],
        [1, 1, "2024-06-01", "2024-06-15", "devolvido", "2024-06-14"]
    )
    bd.Adicionar_dado_a_table_ESPECIFICO(
        "Emprestimo",
        ["id_livro", "id_cliente", "data_emprestimo", "data_devolucao", "status", "data_retornado"],
        [2, 2, "2024-06-03", "2024-06-17", "devolvido", "2024-06-17"]
    )
